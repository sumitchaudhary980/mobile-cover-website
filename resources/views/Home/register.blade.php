        ...
        <div class="authentication-card">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group">
                    ...
                    <input id="name" class="block mt-1 w-full form-control @error('name') is-invalid @enderror"
                ...
                <div class="form-group mt-4">
                    ...
                    <input id="email" class="block mt-1 w-full form-control @error('email') is-invalid @enderror"
                ...
                <div class="form-group mt-4">
                    ...
                    <input id="phone" class="block mt-1 w-full form-control @error('phone') is-invalid @enderror"
                        type="number" name="phone" value="{{ old('phone') }}" autocomplete="phone">
                    @error('phone')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group mt-4">
                    ...
                    <input id="address" class="block mt-1 w-full form-control @error('address') is-invalid @enderror"
                        type="text" name="address" value="{{ old('address') }}" autocomplete="username">
                    @error('address')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="form-group mt-4">
                    ...
                    <select class="form-control shadow border-dark bottom-select @error('state') is-invalid @enderror"
                        id="inputState" name="state" onchange="updateCities()">
                ...
                <div class="form-group mt-4">
                    ...
                    <select class="form-control shadow border-dark @error('city') is-invalid @enderror" id="inputCity"
                        name="city">
                ...
                <div class="form-group mt-4">
                    ...
                    <input id="password" class="block mt-1 w-full form-control @error('password') is-invalid @enderror"
                ...
                <div class="form-group mt-4">
                    ...
                    <input id="password_confirmation"
                        class="block mt-1 w-full form-control @error('password_confirmation') is-invalid @enderror"
                ...
                <div class="flex items-center justify-end mt-4">
                    ...
                    <button class="ms-4 btn btn-primary">Register</button>
                </div>
            </form>
